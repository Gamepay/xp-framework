 ...
 */
  ...
  class StackTest extends TestCase {
    ...
    public function equalsClone() {
      $this->stack->push(new XPString('green'));
    ...
    public function search() {
      ...
      $this->assertEquals(-1, $this->stack->search(new XPString('non-existant')));
    }
    ...
    public function elementAt() {
      $this->stack->push(new XPString('red'));
      $this->stack->push(new XPString('green'));
      $this->stack->push(new XPString('blue'));

      $this->assertEquals(new XPString('blue'), $this->stack->elementAt(0));
      $this->assertEquals(new XPString('green'), $this->stack->elementAt(1));
      $this->assertEquals(new XPString('red'), $this->stack->elementAt(2));
    }
