 ...
 */
 ...
 use security\password\Algorithm, util\log\Traceable;
   ...
   */
  class security·password·StandardAlgorithm extends \lang\Object implements security·password·Algorithm, Traceable {
    protected
      $cat = NULL;
