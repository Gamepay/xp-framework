 ...
 */
  ...
  namespace webservices\rest\server;
 use 
   ...
   * @purpose Caster
   */
  class RestDataCaster extends \lang\Object {
    private
    ...
    public function simple($data) {
      switch (xp::typeOf($data)) {
        ...
        case 'lang.types.Boolean':
          return \lang\Primitive::unboxed($data);
     ...
     * @return var[]
     */
    public function complex($data, \lang\Type $type) {
      ...
      switch ($typeName) {
        ...
        case 'lang.MapType':
          ...
          $result= array();
          foreach ($data as $key => $value) {
            $result[$key]= $this->complex($value, \lang\Type::forName($type->componentType()->getName()));
          }
          return $result;
        ...
        case 'lang.types.Boolean':
          ...
          return \lang\Primitive::unboxed($type->newInstance($data));
        ...
        case 'lang.types.ArrayList':
          ...
          $result= array();
          foreach ($data as $key => $value) {
            $result[$key]= $this->complex($value, \lang\XPClass::forName('lang.types.String'));
          }
          return $result;
        ...
        default:
          if ($type instanceof XPClass) {
            ...
            $string= \lang\XPClass::forName('lang.types.String');
            ...
            foreach ($type->getFields() as $field) {
              if ($field->getModifiers() & MODIFIER_PUBLIC) {
                ...
                $field->set($result, $this->complex(
                  $data[$field->getName()],
                  \lang\Type::$VAR->equals($field->getType()) ? $string : $field->getType()
                ));
