 ...
 */
  ...
  namespace peer\mail;
 use peer\mail\InternetAddress, util\Date;
  ...
  class Message extends \lang\Object {
    ...
    protected function _qstr($str) {
      ...
      if (!isset($q)) $q= \text\encode\QuotedPrintable::getCharsToEncode();
      $n= FALSE;
      ...
      return $n ? \text\encode\QuotedPrintable::encode($str, $this->getCharset()) : $str;
    }
