 ...
 */
   ...
   * @purpose  Base class
   */
  class XPThrowable extends Exception implements Generic {
    public
      $__id;
    ...
    static function __static() {
      ...
      xp::$registry['details.php.Exception']= array(
        ...
        1 => array(
          ...
          'getPrevious'      => array(1 => array(), 'lang.XPThrowable', array(), NULL, array()),
    ...
    public function __construct($message, $cause= NULL) {
      ...
      // TODO Remove: only there for finding wrong usages of 'new XPThrowable()'
      if ($cause && !$cause instanceof XPThrowable) try { throw new Exception('Called not with XPThrowable'); } catch (Exception $e) { Logger::getInstance()->getCategory()->warn($e->getTraceAsString()); }
      $this->cause= $cause;
    ...
    public static function __callStatic($name, $args) {
      ...
      $t= debug_backtrace();
      throw new XPError('Call to undefined method '.$t[1]['class'].'::'.$name);
    }
    ...
    public function __call($name, $args) {
      ...
      throw new XPError('Call to undefined method '.$this->getClassName().'::'.$name.'() from scope '.xp::nameOf($scope));
    }
     ...
     *
     * @see     xp://lang.XPThrowable#toString
