 ...
 */
  ...
  use </xsl:text><xsl:value-of select="concat(/document/table/@namespace, '\base\', my:camelCase(/document/table/@class), 'ServiceBase', ' as ', my:camelCase(/document/table/@class), 'ServiceBase', ';')"/><xsl:text>
  use </xsl:text><xsl:value-of select="concat(/document/table/@namespace, '\', my:camelCase(/document/table/@class), 'ServiceInterface', ' as ', my:camelCase(/document/table/@class), 'ServiceInterface', ';')"/><xsl:text>&#10;</xsl:text>
