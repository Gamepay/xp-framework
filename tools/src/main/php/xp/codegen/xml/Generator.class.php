 ...
 */
   ...
   * XML
   * ===
   * Generates XML files from a database for further processing
   *
   * Usage:
   * <pre>
   *   $ cgen ... xml {dsn} [-p {package}] [-h {host}] [-l {language}] [-n {nstrategy}] [-pv {prefix} [-pt {ptargets}] [-pe {pexclude}]]
   * </pre>
   *
   * Options
   * -------
   ...
   * Languages
   * ---------
   * The following languages are supported: xml
   *
